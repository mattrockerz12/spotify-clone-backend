...
using SpotifyClone.Core.Domain;
using SpotifyClone.Core.Domain.Contracts;
using SpotifyClone.Core.Identity.Users.Abstractions;
using SpotifyClone.Infrastructure.Identity.Audit;
using MediatR;
...
namespace SpotifyClone.Infrastructure.Persistence.Interceptors;
